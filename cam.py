...
# # ══════════════════════════════════════════════════════════════
# # OCR & IMAGE FUNCTIONS (IMPROVED FOR PERFECT DETECTION)
# # ══════════════════════════════════════════════════════════════
# def clean_plate_text(raw):
#     return re.sub(r"[^A-Z0-9]", "", raw.upper())

# def validate_plate(text):
#     # Minimum 8 characters ensures we don't accept partial reads like 'N47BW96'
...
# # ══════════════════════════════════════════════════════════════
# # DISPLAY & OCR PIPELINE HELPERS (IMPROVED PIPELINE)
# # ══════════════════════════════════════════════════════════════
...
#                     # 1. Check with DB immediately for perfect/fuzzy match
...
#                     # 2. If not in DB, wait for 2 consecutive matching frames
...
# ──────────────────────────────────────────────────────────────
TESSERACT_PATH     = "C:/Program Files/Tesseract-OCR/tesseract.exe"   
EMAIL_SENDER       = "dhanasekaranp00@gmail.com"
EMAIL_PASSWORD     = "suiw jdje ttyq eykd"
CSV_DB_PATH        = "vehicle_data_template.csv"  
LOG_CSV_PATH       = "violation_log.csv"
VEHICLE_MODEL_PATH = "yolov8n.pt"
CUSTOM_MODEL_PATH  = "models/best.pt"
